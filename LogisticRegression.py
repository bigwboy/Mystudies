...
plot_decision_regions(X_COMBINDED_STD,y_combined,classifier=lr,test_idx=range(105,150))
plt.legend(loc='upper left')
#plt.show()



print(lr.predict_proba(X_test_std[0:,0:]))